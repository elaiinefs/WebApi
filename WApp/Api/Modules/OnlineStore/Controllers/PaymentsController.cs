...
namespace WApp.Api.Modules.OnlineStore.Controllers
{
    ...
    public class PaymentsController : Controller
    {
        ...
        public PaymentsController(IStripeService stripeService, IConfiguration config, ILogger<PaymentsController> logger, IErrorHandlerService errorService, IOrderService orderService)
        {
            _config = config;
            _logger = logger;
