...
namespace WApp.Api.Infraestructure.Core.Services
{
    public class MessageService : IMessageService
    {
        ...
        public MailMessage GenerateMessage(string actionDescription, string phoneNumber = "", string to = "")
        {
            ...
            try
            {
                if (phoneNumber != "")
                {
                    SendText(mm, client, phoneNumber);
                }
                if (to != "" && to != null)
                {
        ...
        private string GetBody(string user = "", string business = "", string owner = "", string orderdesc = "", string deliverdate = "", string baddr = "", string bcity = "", string bstate = "", string bzcode = "", string deliverhr = "", string title = "", string useremail = "")
        {
            return "<body style='font-family: sans-serif;font-size: 14px; line-height: 1.4; margin: 0; padding: 0; -ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%; background-color: #f6f6f6; width: 100%;'><div><table style='border-collapse: separate;width: 100%;' class='body' border='0' cellspacing='0' cellpadding='0'><tbody><tr><td></td></tr><tr><td>&nbsp;</td><td class='container' style='display: block;Margin: 0 auto !important;max-width: 580px; padding: 10px; width:auto !important; width: 580px;'><div class='content' style='box-sizing: border-box; display: block; Margin: 0 auto;max-width: 580px; padding: 10px;'><span class='preheader' style='color: transparent; display: none; height: 0; max-height: 0; max-width: 0; opacity: 0; overflow: hidden; mso-hide: all; visibility: hidden; width: 0;'>"
                ...
                "Hola " + owner + ",</p><p style='font-family: sans-serif;font-size: 14px; font-weight: normal; margin: 0;Margin-bottom: 15px;'>" + user + " ha creado una orden para "
                + business + ", favor actualizar el estado de la orden. </p><h3> Detalles de la orden: </h3> <p><b> Creador: </b>" + useremail + " </p> <p><b> Orden: </b>"
                + title +
